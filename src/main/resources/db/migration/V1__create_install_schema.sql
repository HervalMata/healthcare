...
CREATE TABLE IF NOT EXISTS `health_care_v1_dev`.`user` (
  ...
  `state_card_no` VARCHAR(255) NOT NULL,
  `federal_card_no` VARCHAR(255) NULL DEFAULT NULL,
  ...
  `vacation_note` VARCHAR(1000) NOT NULL,
