...
public class AgencyTypeController extends AbstractBasedAPI {
	...
	@ApiImplicitParam(name = "id", value = "get agency type", required = true, dataType = "Long")
	@GetMapping("/{id}")
	...
	@ApiImplicitParam(name = "id", value = "delete agency type", required = true, dataType = "Long")
	@DeleteMapping("/{id}")
