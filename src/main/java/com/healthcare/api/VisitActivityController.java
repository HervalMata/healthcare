...
public class VisitActivityController {
	...
	public List<VisitActivity> getAllActivity(@PathVariable Long visitId) {
		return visitActivityService.findVisitActivityByVisitId(visitId);
	}
	
	@ApiOperation(value = "get all visit activity by activity id", notes = "get all visit activity by activity id")
	@ApiImplicitParam(name = "activityId", value = "activity id", required = true, dataType = "Long", paramType = "path")
	@GetMapping("activity/{activityId}")
	public List<VisitActivity> getAllVisit(@PathVariable Long activityId) {
		return visitActivityService.findVisitActivityByActivityId(activityId);
	}
