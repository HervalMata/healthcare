...
public class WorkItemController {
	...
	@ApiImplicitParam(name = "id", value = "get work item", required = true, dataType = "Long")
	@GetMapping("/{id}")
	...
	@ApiImplicitParam(name = "id", value = "delete work item", required = true, dataType = "Long")
	@DeleteMapping("/{id}")
